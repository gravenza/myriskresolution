		...
		if($this->form_validation->run() == FALSE){
			...
			if ( $this -> _check_capthca($captcha) ){
				...
				if($insert){
					...
					$captcha_result = 'Contact Us Marketcity Succeed';
	        ...
	        'allow_self_signed' => true
				...
				$mail->Password = "sketsa88"; 

					$mail->From     = $email;
					$mail->FromName = $name;
					//$mail->AddAddress("yudi@sketsa.net","Yudi");
					$mail->AddAddress("dian.nugrahaeni@dnk-lawfirm.id","Info");
					$mail->AddBCC("hey_abud@yahoo.com");
					//$mail->AddBCC("globaloptimadigital@gmail.com");
